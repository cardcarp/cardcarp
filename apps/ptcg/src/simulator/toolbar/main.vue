<script setup>
// The rail: the tools a player picks up, and the buttons under them. What is on it, and in what
// order, is controls.js's; this draws the list.
...
// The table, through its object (see use-table.js), and what this app puts on the rail.
...
// The rail's tools, with what the template asks of each worked out once. An entry lights for its own
// tool unless it names others, and its hint comes from the list the keyboard binds — the key itself is
// bound in shortcuts.js with the rest — so a tool this app gives no key shows none.
