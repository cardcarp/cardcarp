...
// Logic
//
// The draw maths lives in probability.js, where it is checked against the edges a real table reaches:
// a seven-card hand off a five-card storage list used to compute 1 - 0/0 and print "NaN" in the
// column below (see probability.test.mjs).
import { drawChance, shuffle } from './probability.js'
