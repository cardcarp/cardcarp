...
const { changeColor: arrowChangeColor } = useTable().arrows

const ui_selection = useStore(uiSelection)

const popoverColor = ref(false)

// Swatches hand back a bare "H S L" triplet; arrowChangeColor wraps it into the stroke.
function pick_color(color) {
    arrowChangeColor(color)
...
AnimatePresence
    Motion(
        ...
        //- Chip previews the current stroke; clicking opens the shared swatch grid.
                    ...
                    TooltipTrigger
                        .tool-color(
                            ...
                            .chip(
                                ...
                                :style="{ backgroundColor: ui_selection?.data?.stroke }"
                            )
