...
// Holds the deck.list for the currently-dragging row so onPointerUp can rebuild it on drop
...
Motion(
    ...
    .item(
        ...
        //- Optional chain, not decoration: `format` is nullable and mtg leaves it null on
        //- 1,339 of its 1,562 decks. Unguarded this threw on the first row and took the whole
        //- archive list with it — the tab rendered empty and the aborted subtree then failed
        //- again on unmount, which is what made it look like an animation bug.
