// The table's shared state, run for real under Node. store.js stopped needing Vue when it moved
// onto stores, and importing it here with no browser and no framework is the proof of that.
// Run: node packages/simulator/src/store.test.mjs
