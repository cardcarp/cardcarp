...
// The sheet is controls.js's keys, read rather than restated. It used to be a copy kept in sync by
// hand, and it had drifted: Arrow's A, Move to Bottom's ⇧↓ and Roll Dice's L were never on it. Only
// the headings are this dialog's own. An entry picks its heading with `group`, in the order the keys
// are listed, and a heading no entry picked is left off.
const GROUPS = [
    {
        id: 'navigation',
